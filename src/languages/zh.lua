...
s:set("assertion.same.positive", "希望对象应该相同. 实际:\n%s\n希望:\n%s")
s:set("assertion.same.negative", "希望对象应该不相同. 实际:\n%s\n不希望是:\n%s")

s:set("assertion.equals.positive", "希望对象应该相等. 实际:\n%s\n希望:\n%s")
s:set("assertion.equals.negative", "希望对象应该不相等. 实际:\n%s\n不希望是:\n%s")
